...
group that is being handled. A TypeError is raised if a matching
...
If the subject value is not a sequence [2], the sequence pattern
fails.
...
If name_or_attr is not an instance of the builtin type , raise
TypeError.
...
For typing.TypeVars declared using the type parameter list syntax,
...
typing.TypeVarTuples and typing.ParamSpecs cannot have bounds
or constraints.
...
transformed into the function’s __doc__ attribute and
therefore the function’s docstring.

A string literal appearing as the first statement in the class body is
transformed into the namespace’s __doc__ item and therefore
