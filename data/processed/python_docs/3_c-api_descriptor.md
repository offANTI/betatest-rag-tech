...
Return value: New reference. Part of the Stable ABI.Create a new get-set descriptor for extension type type from the
...
of descriptor created for entries in tp_getset, and
it appears in Python as a types.GetSetDescriptorType object.
...
Return value: New reference. Part of the Stable ABI.Create a new member descriptor for extension type type from the
...
tp_members, and it appears in Python as a
...
PyTypeObject PyMemberDescr_Type
 ...
 Part of the Stable ABI.The type object for member descriptor objects created from
...
PyTypeObject PyGetSetDescr_Type
 ...
 Part of the Stable ABI.The type object for get/set descriptor objects created from
...
Return value: New reference. Part of the Stable ABI.Create a new method descriptor for extension type type from the
...
tp_methods, and it appears in Python as a
...
PyTypeObject PyMethodDescr_Type
 ...
 Part of the Stable ABI.The type object for method descriptor objects created from
...
Return value: New reference.Create a new wrapper descriptor for extension type type from the
...
types.WrapperDescriptorType object.
On success, return a strong reference to the descriptor. Return
NULL with an exception set on failure.
...
PyTypeObject PyWrapperDescr_Type
 ...
 Part of the Stable ABI.The type object for wrapper descriptor objects created by
...
Return value: New reference. Part of the Stable ABI.Create a new class method descriptor for extension type type from the
PyMethodDef structure method.
...
METH_CLASS entries in tp_methods, and it
...
Return value: New reference. Part of the Stable ABI.Create a new bound wrapper object from the wrapper descriptor d and the
instance self.
...
types.MethodWrapperType objects.
On success, return a strong reference to the wrapper object. Return
NULL with an exception set on failure.
...
PyTypeObject PySuper_Type
 ...
 Part of the Stable ABI.The type object for super objects. This is the same object as
...
PyTypeObject PyClassMethodDescr_Type
 ...
 Part of the Stable ABI.The type object for C-level class method descriptor objects.
This is the type of the descriptors created for classmethod() defined
