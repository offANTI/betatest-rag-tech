...
void PyObject_GC_Track(PyObject *op)
 ...
 Part of the Stable ABI.Adds the object op to the set of container objects tracked by the
...
int PyObject_GC_IsTracked(PyObject *op)
 ...
 Part of the Stable ABI since version 3.9.Returns 1 if the object type of op implements the GC protocol and op is being
...
int PyObject_GC_IsFinalized(PyObject *op)
 ...
 Part of the Stable ABI since version 3.9.Returns 1 if the object type of op implements the GC protocol and op has been
...
void PyObject_GC_UnTrack(void *op)
 ...
 Part of the Stable ABI.Remove the object op from the set of container objects tracked by the
...
typedef int (*visitproc)(PyObject *object, void *arg)
 ...
 Part of the Stable ABI.Type of the visitor function passed to the tp_traverse handler.
...
typedef int (*traverseproc)(PyObject *self, visitproc visit, void *arg)
 ...
 Part of the Stable ABI.Traversal function for a container object.  Implementations must call the
...
typedef int (*inquiry)(PyObject *self)
 ...
 Part of the Stable ABI.Drop references that may have created reference cycles.  Immutable objects
...
Py_ssize_t PyGC_Collect(void)
 ...
 Part of the Stable ABI.Perform a full garbage collection, if the garbage collector is enabled.
...
int PyGC_Enable(void)
 ...
 Part of the Stable ABI since version 3.10.Enable the garbage collector: similar to gc.enable().
...
int PyGC_Disable(void)
 ...
 Part of the Stable ABI since version 3.10.Disable the garbage collector: similar to gc.disable().
Returns the previous state, 0 for disabled and 1 for enabled.
