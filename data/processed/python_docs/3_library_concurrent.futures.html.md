...
Changed in version 3.13: max_workers uses os.process_cpu_count() by default, instead of
os.cpu_count().
...
Changed in version 3.14.7: Fixed a deadlock (gh-115634) where the executor could hang after
