...
Py_BEGIN_ALLOW_THREADS
 ...
 Part of the Stable ABI.This macro expands to { PyThreadState *_save; _save = PyEval_SaveThread();.
...
type PyThreadState
 ...
 Part of the Limited API (as an opaque struct).This data structure represents the state of a single thread.  The only public
data member is:
...
PyThreadState *PyEval_SaveThread()
 ...
 Part of the Stable ABI.Detach the attached thread state and return it.
...
void PyEval_RestoreThread(PyThreadState *tstate)
 ...
 Part of the Stable ABI.Set the attached thread state to tstate.
...
PyThreadState *PyThreadState_Get()
 ...
 Part of the Stable ABI.Return the attached thread state. If the thread has no attached
...
PyThreadState *PyThreadState_Swap(PyThreadState *tstate)
 ...
 Part of the Stable ABI.Set the attached thread state to tstate, and return the
...
type PyGILState_STATE
 ...
 Part of the Stable ABI.The type of the value returned by PyGILState_Ensure() and passed to
PyGILState_Release().
...
PyGILState_STATE PyGILState_Ensure()
 ...
 Part of the Stable ABI.Ensure that the current thread is ready to call the Python C API regardless
...
void PyGILState_Release(PyGILState_STATE)
 ...
 Part of the Stable ABI.Release any resources previously acquired.  After this call, Python’s state will
...
PyThreadState *PyGILState_GetThisThreadState()
 ...
 Part of the Stable ABI.Get the attached thread state for this thread.  May return NULL if no
...
PyThreadState *PyThreadState_New(PyInterpreterState *interp)
 ...
 Part of the Stable ABI.Create a new thread state object belonging to the given interpreter object.
...
void PyThreadState_Clear(PyThreadState *tstate)
 ...
 Part of the Stable ABI.Reset all information in a thread state object.  tstate
must be attached
...
void PyThreadState_Delete(PyThreadState *tstate)
 ...
 Part of the Stable ABI.Destroy a thread state object.  tstate should not
...
Return value: Borrowed reference. Part of the Stable ABI.Return a dictionary in which extensions can store thread-specific state
...
void PyEval_AcquireThread(PyThreadState *tstate)
 ...
 Part of the Stable ABI.Attach tstate to the current thread,
...
void PyEval_ReleaseThread(PyThreadState *tstate)
 ...
 Part of the Stable ABI.Detach the attached thread state.
...
int Py_AddPendingCall(int (*func)(void*), void *arg)
 ...
 Part of the Stable ABI.Schedule a function to be called from the main interpreter thread.  On
...
int Py_MakePendingCalls(void)
 ...
 Part of the Stable ABI.Execute all pending calls. This is usually executed automatically by the
interpreter.
...
int PyThreadState_SetAsyncExc(unsigned long id, PyObject *exc)
 ...
 Part of the Stable ABI.Asynchronously raise an exception in a thread. The id argument is the thread
...
unsigned long PyThread_start_new_thread(void (*func)(void*), void *arg)
 ...
 Part of the Stable ABI.Start function func in a new thread with argument arg.
...
unsigned long PyThread_get_thread_ident(void)
 ...
 Part of the Stable ABI.Return the identifier of the current thread, which will never be zero.
...
PyObject *PyThread_GetInfo(void)
 ...
 Part of the Stable ABI since version 3.3.Get general information about the current thread in the form of a
...
unsigned long PyThread_get_thread_native_id(void)
 ...
 Part of the Stable ABI on platforms with native thread IDs.Get the native identifier of the current thread as it was assigned by the operating
...
void PyThread_exit_thread(void)
 ...
 Part of the Stable ABI.Terminate the current thread. This function is generally considered unsafe
...
this calls pthread_exit(3), which attempts to unwind the stack
...
void PyThread_init_thread(void)
 ...
 Part of the Stable ABI.Initialize PyThread* APIs. Python executes this function automatically,
...
int PyThread_set_stacksize(size_t size)
 ...
 Part of the Stable ABI.Set the stack size of the current thread to size bytes.
...
size_t PyThread_get_stacksize(void)
 ...
 Part of the Stable ABI.Return the stack size of the current thread in bytes, or 0 if the system’s
