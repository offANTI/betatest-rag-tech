...
Identify the module corresponding to python.exe or
...
Write the full script path into the debugger_script_path buffer.
...
Use the offsets to locate a valid PyThreadState.

Write the path to a Python script into debugger_script_path.

Set the debugger_pending_call flag to 1.
