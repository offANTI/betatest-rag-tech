...
void Py_Initialize()
 ...
 Part of the Stable ABI.Initialize the Python interpreter.  In an application embedding Python,
...
void Py_InitializeEx(int initsigs)
 ...
 Part of the Stable ABI.This function works like Py_Initialize() if initsigs is 1. If
...
int Py_IsInitialized()
 ...
 Part of the Stable ABI.Return true (nonzero) when the Python interpreter has been initialized, false
...
int Py_IsFinalizing()
 ...
 Part of the Stable ABI since version 3.13.Return true (non-zero) if the main Python interpreter is
...
int Py_FinalizeEx()
 ...
 Part of the Stable ABI since version 3.6.Undo all initializations made by Py_Initialize() and subsequent use of
...
void Py_Finalize()
 ...
 Part of the Stable ABI.This is a backwards-compatible version of Py_FinalizeEx() that
...
int Py_Main(int argc, wchar_t **argv)
 ...
 Part of the Stable ABI.The main program for the standard interpreter, encapsulating a full
...
void Py_SetProgramName(const wchar_t *name)
 ...
 Part of the Stable ABI.This API is kept for backward compatibility: setting
...
wchar_t *Py_GetProgramName()
 ...
 Part of the Stable ABI.Return the program name set with PyConfig.program_name, or the default.
...
wchar_t *Py_GetPrefix()
 ...
 Part of the Stable ABI.Return the prefix for installed platform-independent files. This is derived
...
wchar_t *Py_GetExecPrefix()
 ...
 Part of the Stable ABI.Return the exec-prefix for installed platform-dependent files.  This is
...
wchar_t *Py_GetProgramFullPath()
 ...
 Part of the Stable ABI.Return the full program name of the Python executable; this is  computed as a
...
wchar_t *Py_GetPath()
 ...
 Part of the Stable ABI.Return the default module search path; this is computed from the program name
...
const char *Py_GetVersion()
 ...
 Part of the Stable ABI.Return the version of this Python interpreter.  This is a string that looks
something like
...
const char *Py_GetPlatform()
 ...
 Part of the Stable ABI.Return the platform identifier for the current platform.  On Unix, this is
...
const char *Py_GetCompiler()
 ...
 Part of the Stable ABI.Return an indication of the compiler used to build the current Python version,
...
const char *Py_GetBuildInfo()
 ...
 Part of the Stable ABI.Return information about the sequence number and build date and time of the
...
wchar_t *Py_GetPythonHome()
 ...
 Part of the Stable ABI.Return the default “home”, that is, the value set by
