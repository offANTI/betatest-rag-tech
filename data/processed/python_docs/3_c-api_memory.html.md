...
void *PyMem_RawMalloc(size_t n)
 ...
 Part of the Stable ABI since version 3.13.Allocates n bytes and returns a pointer of type void* to the
...
void *PyMem_RawCalloc(size_t nelem, size_t elsize)
 ...
 Part of the Stable ABI since version 3.13.Allocates nelem elements each of size elsize bytes and returns
...
void *PyMem_RawRealloc(void *p, size_t n)
 ...
 Part of the Stable ABI since version 3.13.Resizes the memory block pointed to by p to n bytes. The contents will
...
void PyMem_RawFree(void *p)
 ...
 Part of the Stable ABI since version 3.13.Frees the memory block pointed to by p, which must have been returned by a
...
void *PyMem_Malloc(size_t n)
 ...
 Part of the Stable ABI.Allocates n bytes and returns a pointer of type void* to the
allocated memory, or NULL if the request fails.
Requesting zero bytes returns a distinct non-NULL pointer if possible, as
...
void *PyMem_Calloc(size_t nelem, size_t elsize)
 ...
 Part of the Stable ABI since version 3.7.Allocates nelem elements each of size elsize bytes and returns
a pointer of type void* to the allocated memory, or NULL if the
request fails. The memory is initialized to zeros.
Requesting zero elements or elements of size zero bytes returns a distinct
...
void *PyMem_Realloc(void *p, size_t n)
 ...
 Part of the Stable ABI.Resizes the memory block pointed to by p to n bytes. The contents will be
