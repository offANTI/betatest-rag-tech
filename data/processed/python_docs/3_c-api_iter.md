...
int PyIter_NextItem(PyObject *iter, PyObject **item)
 ...
 Part of the Stable ABI since version 3.14.Return 1 and set item to a strong reference of the
...
Return value: New reference. Part of the Stable ABI.This is an older version of PyIter_NextItem(),
