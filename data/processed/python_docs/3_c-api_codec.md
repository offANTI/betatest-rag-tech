...
int PyCodec_KnownEncoding(const char *encoding)
 ...
 Part of the Stable ABI.Return 1 or 0 depending on whether there is a registered codec for
...
int PyCodec_RegisterError(const char *name, PyObject *error)
 ...
 Part of the Stable ABI.Register the error handling callback function error under the given name.
...
Return value: New reference. Part of the Stable ABI.Lookup the error handling callback function registered under name.  As a
...
Return value: New reference. Part of the Stable ABI.Replace the unicode encode error with backslash escapes (\x, \u and
\U).
