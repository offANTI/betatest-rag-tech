...
Changed in version 3.8: The default dict_type is dict, since it now preserves
insertion order.


Changed in version 3.13: Raise a MultilineContinuationError when allow_no_value is
