...
Documentation on module objectsProvides details on the special attributes that can be found on
...
Generic Alias TypesIn-depth documentation on instances of types.GenericAlias

PEP 585 - Type Hinting Generics In Standard CollectionsIntroducing the types.GenericAlias class
...
changes.
MappingProxyTypes are generic over two types,
