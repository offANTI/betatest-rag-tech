...
These ABCs override __subclasshook__() to support
testing an interface by verifying the required methods are present
and have not been set to None.  This only works for simple
...
registered as Iterable or that have an __iter__()
