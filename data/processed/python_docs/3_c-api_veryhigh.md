...
int (*PyOS_InputHook)(void)
 ...
 Part of the Stable ABI.Can be set to point to a function with the prototype
...
Return value: New reference.Execute Python source code from str in the context specified by the
...
Return value: New reference. Part of the Stable ABI.This is a simplified interface to Py_CompileStringFlags() below, leaving
flags set to NULL.
...
Return value: New reference.Like Py_CompileStringObject(), but filename is a byte string
...
Return value: New reference. Part of the Stable ABI.This is a simplified interface to PyEval_EvalCodeEx(), with just
...
Return value: New reference. Part of the Stable ABI.Evaluate a precompiled code object, given a particular environment for its
...
Return value: New reference. Part of the Stable ABI.This is the main, unvarnished function of Python interpretation.  The code
...
codeop module.  Do not use it; its behavior is unsupported
...
SyntaxError.  The codeop module sets this flag,
together with PyCF_DONT_IMPLY_DEDENT, to tell input
...
compilation fails with a SyntaxError:
...
The compile(), eval() and exec() built-in functions
set this flag when the source is a str object, because they
...
PyCF_MASK¶
Bitmask of all CO_FUTURE flags (see Code Object Flags),
...
compiled, such as PyCF_ONLY_AST.
The compile() built-in function uses this mask to validate
its flags argument.
