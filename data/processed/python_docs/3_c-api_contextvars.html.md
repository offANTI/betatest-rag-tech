...
Return value: New reference.Create a new empty context object.  Returns NULL if an error
has occurred.
...
Return value: New reference.Create a shallow copy of the passed ctx context object.
...
Return value: New reference.Create a shallow copy of the current thread context.
Returns NULL if an error has occurred.
...
Return value: New reference.Create a new ContextVar object.  The name parameter is used
...
Return value: New reference.Set the value of var to value in the current context.  Returns
