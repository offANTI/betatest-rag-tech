...
classmethods that are used as alternative constructors and return instances
...
PEP 593 - Flexible function and variable annotationsThe PEP introducing Annotated to the standard library.
...
cast() may be required in the body of the add_logging
...
eq_default (bool) – Indicates whether the eq parameter is assumed to be
True or False if it is omitted by the caller.
Defaults to True.
order_default (bool) – Indicates whether the order parameter is
assumed to be True or False if it is omitted by the caller.
Defaults to False.
kw_only_default (bool) – Indicates whether the kw_only parameter is
assumed to be True or False if it is omitted by the caller.
Defaults to False.
frozen_default (bool) – Indicates whether the frozen parameter is
assumed to be True or False if it is omitted by the caller.
Defaults to False.
...
field_specifiers (tuple[Callable[..., Any], ...]) – Specifies a static list of supported classes
