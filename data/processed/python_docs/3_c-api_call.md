...
Return value: New reference. Part of the Stable ABI.Call a callable Python object callable, with arguments given by the
...
Return value: New reference. Part of the Stable ABI since version 3.10.Call a callable Python object callable without any arguments. It is the
...
Return value: New reference.Call a callable Python object callable with exactly 1 positional argument
...
Return value: New reference. Part of the Stable ABI.Call a callable Python object callable, with a variable number of C arguments.
...
Return value: New reference. Part of the Stable ABI.Call the method named name of object obj with a variable number of C
...
Return value: New reference. Part of the Stable ABI.Call a callable Python object callable, with a variable number of
...
Return value: New reference. Part of the Stable ABI.Call a method of the Python object obj, where the name of the method is given as a
...
PyObject *PyObject_Vectorcall(PyObject *callable, PyObject *const *args, size_t nargsf, PyObject *kwnames)
 ...
 Part of the Stable ABI since version 3.12.Call a callable Python object callable.
...
PyObject *PyObject_VectorcallMethod(PyObject *name, PyObject *const *args, size_t nargsf, PyObject *kwnames)
 ...
 Part of the Stable ABI since version 3.12.Call a method using the vectorcall calling convention. The name of the method
...
int PyCallable_Check(PyObject *o)
 ...
 Part of the Stable ABI.Determine if the object o is callable.  Return 1 if the object is callable
