...
Return value: New reference.Return a bytes object containing the marshalled representation of value.
version indicates the file format.
...
Return value: New reference.Return a Python object from the data stream in a FILE* opened for
reading.
...
Return value: New reference.Return a Python object from the data stream in a byte buffer
