...
const unsigned long Py_Version
 ...
 Part of the Stable ABI since version 3.11.The Python runtime version number encoded in a single constant integer.
See Py_PACK_FULL_VERSION() for the encoding details.
...
uint32_t Py_PACK_FULL_VERSION(int major, int minor, int micro, int release_level, int release_serial)
 ...
 Part of the Stable ABI since version 3.14.Return the given version, encoded as a single 32-bit integer with
...
Version
Py_PACK_FULL_VERSION arguments
Encoded version
...
uint32_t Py_PACK_VERSION(int major, int minor)
 ...
 Part of the Stable ABI since version 3.14.Equivalent to Py_PACK_FULL_VERSION(major, minor, 0, 0, 0).
