...
Return value: New reference.Return a new function object associated with the code object code. globals
...
Return value: Borrowed reference.Return a borrowed reference to the __module__
...
Return value: Borrowed reference.Return the keyword-only argument default values of the function object op. This can be a
...
Return value: Borrowed reference.Return the annotations of the function object op. This can be a
...
Return value: Borrowed reference.These functions are similar to their PyFunction_Get* counterparts, but
