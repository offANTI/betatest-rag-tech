...
int PyOS_snprintf(char *str, size_t size, const char *format, ...)
 ...
 Part of the Stable ABI.Output not more than size bytes to str according to the format string
...
unsigned long PyOS_strtoul(const char *str, char **ptr, int base)
 ...
 Part of the Stable ABI.Convert the initial part of the string in str to an unsigned long value according to the given base, which must be between 2 and
...
long PyOS_strtol(const char *str, char **ptr, int base)
 ...
 Part of the Stable ABI.Convert the initial part of the string in str to an long value
...
double PyOS_string_to_double(const char *s, char **endptr, PyObject *overflow_exception)
 ...
 Part of the Stable ABI.Convert a string s to a double, raising a Python
...
char *PyOS_double_to_string(double val, char format_code, int precision, int flags, int *ptype)
 ...
 Part of the Stable ABI.Convert a double val to a string using supplied
...
int PyOS_mystrnicmp(const char *str1, const char *str2, Py_ssize_t size)
 ...
 Part of the Stable ABI.Case insensitive comparison of strings. These functions work almost
