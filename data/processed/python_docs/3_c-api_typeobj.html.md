...
protocol.
When a user sets __call__ in Python code, only tp_call is
...
Py_TPFLAGS_BASETYPE¶
 Part of the Stable ABI.This bit is set when the type can be used as the base type of another type.  If
...
Py_TPFLAGS_HAVE_GC¶
 Part of the Stable ABI.This bit is set when the object supports garbage collection.  If this bit
...
Py_TPFLAGS_DEFAULT¶
 Part of the Stable ABI.This is a bitmask of all the bits that pertain to the existence of certain
...
Py_TPFLAGS_METHOD_DESCRIPTOR¶
 Part of the Stable ABI since version 3.8.This bit indicates that objects behave like unbound methods.
...
Py_TPFLAGS_ITEMS_AT_END¶
 Part of the Stable ABI since version 3.12.Only usable with variable-size types, i.e. ones with non-zero
tp_itemsize.
...
Py_TPFLAGS_HAVE_VECTORCALL¶
 Part of the Stable ABI since version 3.12.This bit is set when the class implements
...
typedef PyObject *(*allocfunc)(PyTypeObject *cls, Py_ssize_t nitems)
 ...
 Part of the Stable ABI.The purpose of this function is to separate memory allocation from memory
...
typedef int (*setattrfunc)(PyObject *self, char *attr, PyObject *value)
 ...
 Part of the Stable ABI.Set the value of the named attribute for the object.
