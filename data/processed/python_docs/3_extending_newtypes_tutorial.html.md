...
What a Custom object contains: this is the CustomObject
struct, which is allocated once for each Custom instance.

How the Custom type behaves: this is the CustomType struct,
which defines a set of flags and function pointers that the interpreter
inspects when specific operations are requested.

How to define and execute the custom module: this is the
