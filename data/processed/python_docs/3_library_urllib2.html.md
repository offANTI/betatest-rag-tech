...
Changed in version 3.14.7 (unreleased): Authentication credentials for URIs with a scheme are now scoped by
that scheme.
...
calls to urlretrieve().  It also resets the default global opener
installed by install_opener().
