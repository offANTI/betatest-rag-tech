...
Inspect the log files in the run subdirectory. You should see the
...
In listener.json, add a socket key with the path to the domain
...
In webapp.json, change the socket handler configuration dictionary
