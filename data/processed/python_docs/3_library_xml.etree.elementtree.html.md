...
Deprecated since version 3.3: The xml.etree.cElementTree alias of this module is deprecated.
...
and can only use the default TreeBuilder as a target.
...
or encoded data (bytes or a bytes-like object).
