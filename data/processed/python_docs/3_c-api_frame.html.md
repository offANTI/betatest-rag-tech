...
Return value: New reference.Get the generator, coroutine, or async generator that owns this frame,
...
Return value: New reference.Similar to PyFrame_GetVar(), but the variable name is a C string
encoded in UTF-8.
...
Return value: New reference.Get the frame’s f_locals attribute.
